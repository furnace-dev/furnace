...
struct Engine[E: Exchangeable, PE: ProExchangeable, S: Strategizable](Movable):
    ...
    fn init(mut self) raises:
        ...
        fn on_ticker(trading_context: TradingContext, ticker: Ticker) -> None:
            ...
            try:
                ...
                loge("strategy on_ticker error: " + String(e))
        ...
        fn on_tickers(
            ...
            try:
                ...
                loge("strategy on_tickers error: " + String(e))
        ...
        fn on_order_book(
            ...
            try:
                ...
                loge("strategy on_order_book error: " + String(e))
        ...
        fn on_trade(trading_context: TradingContext, trade: Trade) -> None:
            ...
            try:
                ...
                loge("strategy on_trade error: " + String(e))
        ...
        fn on_balance(
            ...
            try:
                ...
                loge("strategy on_balance error: " + String(e))
        ...
        fn on_order(trading_context: TradingContext, order: Order) -> None:
            ...
            try:
                ...
                loge("strategy on_order error: " + String(e))
        ...
        fn on_my_trade(trading_context: TradingContext, trade: Trade) -> None:
            ...
            try:
                ...
                loge("strategy on_my_trade error: " + String(e))
    ...
    fn start(mut self) raises:
        ...
        try:
            ...
            logw("init engine error: " + String(e))
            return

        @parameter
        fn run_loop(n: Int) -> None:
            logi("task " + String(n) + " thread id: " + String(gettid()))
            if n == 0:
                try:
                    self.__on_private_ws_run()
                except e:
                    loge("private_ws on_private_ws_run error: " + String(e))
            elif n == 1:
                try:
                    self.__on_public_ws_run()
                except e:
                    loge("public_ws on_public_ws_run error: " + String(e))
        ...
        try:
            ...
            loge("strategy on_deinit error: " + String(e))
...
fn run[
    ...
    try:
        ...
        loge("strategy on_init error: " + String(e))
        return
